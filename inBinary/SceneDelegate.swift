...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let contentView = ContentView().environment(\.application, UIApplication.shared)
...
// MARK: - ApplicationEnvironmentKey

struct ApplicationEnvironmentKey: EnvironmentKey {
    static var defaultValue: UIApplication = .shared
}
